...
export function WarehouseIssueView() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="text-2xl font-semibold mb-1">Wydanie towaru</h1>
      ...
      <div className="flex justify-end gap-3">
        ...
        <button onClick={submit} disabled={issue.isPending || items.length === 0}
          className="px-4 py-2 text-sm bg-orange-600 text-white rounded hover:bg-orange-700 disabled:opacity-50 cursor-pointer">
          {issue.isPending ? "…" : "Zatwierdź wydanie"}
        </button>
      </div>
    </div>
  );
